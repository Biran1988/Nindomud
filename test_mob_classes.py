...
class MobClassTests(unittest.TestCase):
    ...
    def test_mset_fields_are_wrapped_and_player_fields_are_separate(self):
        ...
        self.assertIn('short_desc (short)', mob_reference)
        self.assertIn('act_flags (act)', mob_reference)
        self.assertIn('shop_buys_categories', mob_reference)
        ...
        self.assertIn('maximum_health', player_reference)
        self.assertIn('village_rank (rank)', player_reference)
        self.assertNotIn('shop_buys_categories', player_reference)
