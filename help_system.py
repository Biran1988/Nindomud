...
DEFAULT_HELP_ENTRIES = [
    ...
    },
    {
        ...
        "body": (
            ...
            "  &G[Active]&x\n"
            "\n"
            "&CGemcutter&x - Crafting-only -- cuts Mining's raw gems into polished ones, a valuable trade good.\n"
            "  &G[Active]&x\n"
            "\n"
    ...
    },
    {
        ...
        "body": (
            "Syntax: use <item>\n"
            "\n"
            "Description: Uses a medical item for an immediate effect (typically restoring Health). Only accepts medical-category items.\n"
            "\n"
            "Date: 2026-08-17"
        ),
        "created_by": "System",
    ...
    },
    {
        ...
        "body": (
            "Syntax: farm\n"
            "\n"
            "Description: Tends crops for the Farming job. Needs a hoe held (see 'help hold') and a plains biome to stand in (e.g. a village Farmland, off the Villager's House). Costs 1-2 Stamina. Same tiered-tool, real-chance-to-fail, delayed-resolution treatment as fishing/mining/lumberjack.\n"
            "\n"
            "There are 6 hoes (Copper, Iron, Steel, Chakra Steel, Blacksteel, Diamond-Bladed -- required levels 1/20/40/60/80/99). All 8 crops (Carrot, Potato, Tomato, Onion, Pumpkin, Watermelon, Corn, Pepper) have a full Common-through-Legendary tier ladder, built around your hoe's own tier -- a better hoe always matters more than levels alone, and only the Diamond-Bladed hoe gives a real (though still not guaranteed) shot at Legendary crops. Crops are standalone sellable goods, not consumed by any crafting job.\n"
            "\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "\n"
            "&WNumber fields:&x weight, cost, level, condition, setbonuspercent, concap, hitroll, damageroll, damage\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "\n"
            "Description: Shows an item prototype's full stat block. Wielded items show Hitroll, Damageroll, and Damage. Set them directly with 'oset <vnum> hitroll|damageroll|damage <n>'; damage overrides the weapontype default for that item.\n"
            "\n"
            "&D(Staff only.)&x\n"
            "\n"
            "Date: 2026-08-17"
